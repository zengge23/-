 ...
 <div class="navbar-wrapper">
    ...
    <div class="container theme-showcase" role="main">
      <div class="page-header">
		...
		<form action="/consumer/process/email/address" method="post" role="form" style="margin-top:20px;">
		  <div class="form-group">
			<label for="exampleInputEmail1">邮箱地址</label>
			<input name="emailAddress" type="text" class="form-control" placeholder="请输入用于接收验证码的邮箱地址">
		  </div>
