 ...
 <div class="navbar-wrapper">
    ...
    <div class="container theme-showcase" role="main">
      <div class="page-header">
		...
		<form action="/consumer/process/basicinfo" role="form" style="margin-top:20px;">
		  <div class="form-group">
			<label for="exampleInputEmail1">真实名称</label>
			<input type="text" name="realName" class="form-control" id="exampleInputEmail1" placeholder="请输入真实名称">
		  </div>
		  <div class="form-group">
			<label for="exampleInputPassword1">身份证号码</label>
			<input type="text" name="cardNum" class="form-control" id="exampleInputPassword1" placeholder="请输入身份证号码">
		  </div>
		  <div class="form-group">
			<label for="exampleInputPassword1">电话号码</label>
			<input type="text" name="phoneNum" class="form-control" id="exampleInputPassword1" placeholder="请输入电话号码">
		  </div>
